...
module GHCJS.DOM.JSFFI.Generated.Document
       (js_getAnimations, getAnimations, getAnimations_, js_newDocument,
        newDocument, js_createElement, createElement, createElement_,
        js_createDocumentFragment, createDocumentFragment,
        createDocumentFragment_, js_createTextNode, createTextNode,
        createTextNode_, js_createComment, createComment, createComment_,
        js_createCDATASection, createCDATASection, createCDATASection_,
        js_createProcessingInstruction, createProcessingInstruction,
        createProcessingInstruction_, js_createAttribute, createAttribute,
        createAttribute_, js_getElementsByTagName, getElementsByTagName,
        getElementsByTagName_, js_importNode, importNode, importNode_,
        ...
        getElementsByTagNameNS_, js_adoptNode, adoptNode, adoptNode_,
        ...
        createTreeWalker, createTreeWalker_, js_getOverrideStyle,
        getOverrideStyle, getOverrideStyle_, js_createExpression,
        createExpression, createExpression_, js_createNSResolver,
        createNSResolver, createNSResolver_, js_evaluate, evaluate,
        evaluate_, js_execCommand, execCommand, execCommand_,
        ...
        js_getSelection, getSelection, getSelection_,
        js_getCSSCanvasContext, getCSSCanvasContext, getCSSCanvasContext_,
        js_getElementsByClassName, getElementsByClassName,
        getElementsByClassName_, js_hasFocus, hasFocus, hasFocus_,
        ...
        webkitGetNamedFlows_, js_createTouch, createTouch, createTouch_,
        js_createTouchList, createTouchList, createTouchList_,
        js_getTimeline, getTimeline, js_getDoctype, getDoctype,
        getDoctypeUnsafe, getDoctypeUnchecked, js_getImplementation,
        getImplementation, js_getDocumentElement, getDocumentElement,
        getDocumentElementUnsafe, getDocumentElementUnchecked,
        js_getInputEncoding, getInputEncoding, js_getXmlEncoding,
        ...
        js_getReferrer, getReferrer, js_setDomain, setDomain, js_getDomain,
        getDomain, js_getURL, getURL, js_setCookie, setCookie,
        js_getCookie, getCookie, js_setBody, setBody, js_getBody, getBody,
        getBodyUnsafe, getBodyUnchecked, js_getHead, getHead,
        getHeadUnsafe, getHeadUnchecked, js_getImages, getImages,
        js_getApplets, getApplets, js_getLinks, getLinks, js_getForms,
        getForms, js_getAnchors, getAnchors, js_getEmbeds, getEmbeds,
        js_getPlugins, getPlugins, js_getScripts, getScripts,
        js_getLastModified, getLastModified, js_getLocation, getLocation,
        getLocationUnsafe, getLocationUnchecked, js_getCharset, getCharset,
        ...
        getSelectedStylesheetSetUnchecked, js_getCompatMode, getCompatMode,
        ...
        getWebkitFullscreenElementUnchecked, js_getFonts, getFonts,
        js_getVisibilityState, getVisibilityState, js_getHidden, getHidden,
        visibilitychange, js_getCurrentScript, getCurrentScript,
        getCurrentScriptUnsafe, getCurrentScriptUnchecked, js_getOrigin,
        getOrigin, js_getScrollingElement, getScrollingElement,
        getScrollingElementUnsafe, getScrollingElementUnchecked,
        beforeCopy, beforeCut, beforeinput, beforePaste, copy, cut, paste,
        selectStart, webKitFullscreenChange, webKitFullscreenError,
        selectionchange, readyStateChange, pointerlockchange,
        pointerlockerror, js_getRootElement, getRootElement,
...
createElement self tagName
  = liftIO (js_createElement (toDocument self) (toJSString tagName))
...
createElement_ self tagName
  = liftIO
      (void (js_createElement (toDocument self) (toJSString tagName)))
...
createAttribute self name
  = liftIO (js_createAttribute (toDocument self) (toJSString name))
...
importNode self importedNode deep
  = liftIO
      (js_importNode (toDocument self) (toNode importedNode) deep)
...
importNode_ self importedNode deep
  = liftIO
      (void (js_importNode (toDocument self) (toNode importedNode) deep))
...
adoptNode self source
  = liftIO (js_adoptNode (toDocument self) (toNode source))
...
adoptNode_ self source
  = liftIO (void (js_adoptNode (toDocument self) (toNode source)))
...
createEvent self eventType
  = liftIO (js_createEvent (toDocument self) (toJSString eventType))
...
foreign import javascript unsafe "$1[\"getSelection\"]()"
        js_getSelection :: Document -> IO Selection

-- | <https://developer.mozilla.org/en-US/docs/Web/API/Document.getSelection Mozilla Document.getSelection documentation> 
getSelection :: (MonadIO m, IsDocument self) => self -> m Selection
getSelection self = liftIO (js_getSelection (toDocument self))
...
foreign import javascript unsafe "$1[\"defaultView\"]"
        js_getDefaultView :: Document -> IO Window

-- | <https://developer.mozilla.org/en-US/docs/Web/API/Document.defaultView Mozilla Document.defaultView documentation> 
getDefaultView :: (MonadIO m, IsDocument self) => self -> m Window
getDefaultView self = liftIO (js_getDefaultView (toDocument self))
...
foreign import javascript unsafe "$1[\"readyState\"]"
        js_getReadyState :: Document -> IO JSString
...
getReadyState ::
              (MonadIO m, IsDocument self, FromJSString result) =>
                self -> m result
getReadyState self
  = liftIO (fromJSString <$> (js_getReadyState (toDocument self)))
