...
clientRectGetTop :: (IsClientRect self) => self -> IO Float
...
clientRectGetRight :: (IsClientRect self) => self -> IO Float
...
clientRectGetBottom :: (IsClientRect self) => self -> IO Float
...
clientRectGetLeft :: (IsClientRect self) => self -> IO Float
...
clientRectGetWidth :: (IsClientRect self) => self -> IO Float
...
clientRectGetHeight :: (IsClientRect self) => self -> IO Float
